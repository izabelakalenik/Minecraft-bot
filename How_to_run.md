...
4. Paste the port number from the [botConfig.js](./botConfig.js)
5. Run `node src/index.js` command in the project's terminal (in the root folder)

## Add more task for the bot
1. Open [planner.js](./planner.js) file in the *ai* folder of the project
2. Add a task to the *taskPlan* list
3. Implement the proper task handler in the *for loop* below taskPlan (if it doesn't exist)

## Additional info
- If you want to change bot configuration, edit [botConfig.js](./botConfig.js) file, not [createBot.js](./createBot.js)
